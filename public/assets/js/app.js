...
/* harmony import */ var _components_routines_exercises__WEBPACK_IMPORTED_MODULE_5___default = /*#__PURE__*/__webpack_require__.n(_components_routines_exercises__WEBPACK_IMPORTED_MODULE_5__);
...
function formatExerciseForSearch(exercise) {
  return "<div class=\"exercise--search-result mb-2\">\n<button type=\"button\" data-id=\"".concat(exercise.id, "\">").concat(exercise.name, "</button>\n</div>");
}
