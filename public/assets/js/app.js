...
/* harmony import */ var _components_routines_index__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./components/routines/_index */ "./resources/js/components/routines/_index.js");
...
Alpine.data('routines', _components_routines_index__WEBPACK_IMPORTED_MODULE_4__["default"]);
Alpine.start();
...
function loadExercises(wrapper, search) {
  var url = new URL(wrapper.getAttribute('data-route'));
  if (search) {
    url.searchParams.set('search', search);
  }
  axios.get(url.toString()).then(function (res) {
...
function displayExercises(data) {
  var wrapper = document.getElementById('search-exercises-list');
  if (!wrapper) {
    return;
  }
  var html = '';
  if (data.data.length > 0) {
    data.data.forEach(function (exercise) {
...
/***/ "./resources/js/components/routines/_index.js":
/*!****************************************************!*\
  !*** ./resources/js/components/routines/_index.js ***!
  \****************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (function () {
  return {
    ...
    init: function init() {
      var _this = this;
      axios.get(route('routines.index')).then(function (res) {
        _this.routines = res.data.data;
        _this.loaded = true;
...
/***/ "./resources/js/components/routines/exercises.js":
/*!*******************************************************!*\
  !*** ./resources/js/components/routines/exercises.js ***!
  \*******************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
function loadExercises(wrapper) {
  axios.get(wrapper.getAttribute('data-get')).then(function (res) {
    var html = '';
    var exerciseCount = 0;
    if (res.data.exercises.length === 0) {
      html = '<div class="notification">No exercises yet</div>';
    } else {
      res.data.exercises.forEach(function (exercise) {
        html += (0,_formatting__WEBPACK_IMPORTED_MODULE_0__.formatExercise)(exercise);
      });
...
/***/ "./resources/js/components/routines/formatting.js":
/*!********************************************************!*\
  !*** ./resources/js/components/routines/formatting.js ***!
  \********************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (getClosest);

/***/ }),

/***/ "./resources/js/layout/modals.js":
/*!***************************************!*\
  !*** ./resources/js/layout/modals.js ***!
  \***************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _helpers_get_closest__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../helpers/get-closest */ "./resources/js/helpers/get-closest.js");
...
if (modalTriggers) {
  modalTriggers.forEach(function (trigger) {
    trigger.addEventListener('click', function (event) {
      ...
      var modal = modalId ? document.getElementById(modalId) : false;
      if (!modal) {
        return;
      }
      modal.classList.add('is-active');
      var modalContent = modal.querySelector('input');
      if (modalContent) {
        modalContent.focus();
      }
...
if (modalClosers) {
  modalClosers.forEach(function (closer) {
    closer.addEventListener('click', function (event) {
      event.preventDefault();
      var modal = (0,_helpers_get_closest__WEBPACK_IMPORTED_MODULE_0__["default"])(closer, '.modal');
      if (modal) {
        closeModal(modal);
      }
    });
...
if (modalBackgrounds) {
  modalBackgrounds.forEach(function (background) {
    background.addEventListener('click', function (event) {
      var modal = (0,_helpers_get_closest__WEBPACK_IMPORTED_MODULE_0__["default"])(background, '.modal');
      if (modal) {
        closeModal(modal);
      }
    });
